...
function ChevronList({ items }: { items: string[] }) {
  return (
    <ul className="flex flex-col gap-2.5">
      {items.map((item) => (
        <li key={item} className="font-roboto flex items-start gap-2 text-[15px] leading-relaxed text-white sm:text-[16px]">
...
function SectionTitle({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <h3 className={`font-montserrat mb-4 text-[24px] font-semibold text-[#61ce70] sm:text-[28px] ${className}`}>
      {children}
    </h3>
  );
}
      ...
      <main className="flex-1">
        ...
        <section className="bg-white pt-12 pb-8 lg:pt-16 lg:pb-10">
          <div className="mx-auto w-full max-w-container px-4 sm:px-6">
            ...
            <p className="font-roboto mt-4 text-[16px] leading-relaxed text-[#333]">
        ...
        <section className="bg-white pb-10 lg:pb-12">
          <div className="mx-auto grid w-full max-w-container gap-5 px-4 sm:px-6 lg:grid-cols-2">
            ...
            >
              ...
              <p className="font-roboto mb-5 text-[15px] leading-relaxed text-white">
        ...
        <section className="bg-white pb-14 lg:pb-20">
          <div className="mx-auto w-full max-w-container px-4 sm:px-6">
            ...
            <div
              className="rounded-[20px] border border-[#61ce70] p-[30px] sm:p-10"
              style={{ backgroundImage: SPARK }}
            >
              ...
              <p className="font-roboto mb-6 max-w-[720px] text-[15px] leading-relaxed text-white sm:text-[16px]">
              ...
              <Link
                href="/contact-us"
                className="font-roboto inline-flex items-center gap-2 rounded-[3px] bg-[#61ce70] px-6 py-3 text-[14px] font-semibold uppercase tracking-[1px] text-white transition-colors hover:bg-[#4fbf5f]"
              >
