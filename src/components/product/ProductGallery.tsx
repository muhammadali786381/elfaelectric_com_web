    ...
    <section className="bg-bg-primary py-[70px]">
      <div className="mx-auto w-full max-w-[1150px] px-4 sm:px-6">
        <div className="text-center">
          ...
          <h2 className="font-montserrat mt-2 text-[32px] font-bold uppercase leading-tight tracking-wide text-text-primary sm:text-[44px] lg:text-[56px] lg:leading-[1.05]">
            Product Gallery
          </h2>
        </div>
