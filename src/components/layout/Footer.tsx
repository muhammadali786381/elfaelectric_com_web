...
const contactInfo = [
  { icon: "📞", text: "+92 311 1000 333" },
  { icon: "✉️", text: "info@elfaelectric.com" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-sm mb-6">
              ELFA Electric is Pakistan&apos;s leading electric vehicle brand,
              offering advanced Lithium Iron Phosphate battery technology for a
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-gray-500 text-xs">
            © {new Date().getFullYear()} ELFA Electric. All rights reserved.
          </p>
